...
RUSTFMT_CHECK_FILES := src/lib.rs src/mpsl_common.rs src/mpsl_timeslot.rs src/payload.rs src/transport.rs examples/mpsl_3mode_poll.rs examples/mpsl_3mode_central.rs
