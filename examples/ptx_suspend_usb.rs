...
async fn main(spawner: Spawner) {
    ...
    usb_config.product = Some("PTX Suspend");
    usb_config.serial_number = Some("PTXSUSP");
    ...
    let _ = class.write_packet(b"[PTX Suspend] Ready\r\n").await;
    ...
    loop {
        ...
        let len = {
            ...
            let _ = write!(
                w,
                "[S] c={} q={} a={} f={} m={}\r\n",
                cycle, queued, ack_rx, tx_full, max_attempts
            );
            w.pos
        };
